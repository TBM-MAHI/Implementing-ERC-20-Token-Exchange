...
contract Token {
    ...
    console.log("balanace ",balanceOf[_from]);*/
        require(
            _value <= allowance[_from][msg.sender],
            "ERROR!Sending More Than Approved!"
        );
        require(balanceOf[_from] >= _value, "ERROR! Not Enough Balance! ");
